...
export class PropertyComponent implements OnInit {
  ...
  constructor(
    ...
    private rateService: PropertyService,
  ...
  submitRate() {
    this.rateService.submitRate(this.singleUpdateForm.value).subscribe(
      (res) => {
  ...
  changeOwner() {
    this.rateService.changeOwner(this.changeOwnerForm.value).subscribe(
      (res) => {
